...
const { getAllCategoriesPopular, getParentCategories,   getChildCategories, getCategoryChildrenById, getAttributesByCategoryId,getChildCategoriesByParentId } = require('../controllers/categories');
/**
 * @swagger
 * /categories/popular:
 *   get:
